...
void calcularR(int n, int *v0, int *r, int rn)
{
    ...
    while (rn * (rn - 1) + count_exceed > n)
	count_exceed--;		// Calcula quantos termos "a mais" temos na matriz principal que não formam um grupo de rn elementos (inicialmente é de rn, considerando o pior caso)
